...
db.funcionarios.insert({ 
    ...
    funcao: 'Cuidador de animais', 
    cpf: '885.026.460-79', 
    sexo: 'M', 
    data_nascimento: ISODate("1999-11-01T08:15:39.736Z"), 
    salario: 2300.15,
    ctps: '359.46166.96-2',
    endereco: ObjectId("5ddb8b5d25e6201bc4ee3877")
});

db.funcionarios.insert({ 
    nome: "Gabriel Amâncio", 
    funcao: 'Porteiro', 
    cpf: '103.159.230-08', 
    sexo: 'M', 
    ...
    salario: 1900.00,
    ctps: '540.29952.24-6',
    endereco: ObjectId("5ddb8b5d25e6201bc4ee3878")
});
...
db.funcionarios.insert({ 
    ...
    salario: 3000.23,
    ctps: '561.67490.60-0',
    endereco: ObjectId("5ddb8b5d25e6201bc4ee3879")
});
...
db.funcionarios.insert({ 
    ...
    salario: 4002.23,
    ctps: '652.45379.60-0',
    endereco: ObjectId("5ddb8b5e25e6201bc4ee387b")
});
...
db.funcionarios.insert({ 
    ...
    salario: 1997.23,
    ctps: '722.85535.86-0',
    endereco: ObjectId("5ddb8b5e25e6201bc4ee387a")
});
...
db.clientes.insert({ 
    ...
    endereco: ObjectId("5ddb8bc125e6201bc4ee387d")
});
